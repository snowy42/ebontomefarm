...
EbonTomeFarm = { VERSION = "1.0.2", SCHEMA = 1 }
...
function A:InitStorage()
    ...
    local defaults = { show = true, locked = false, hideDone = true, raids = true, dungeons = true,
        ...
        minimumTier = "C", minimap = true, tomeAlerts = true, tomeSound = true }
...
function A:SaveBuild(build)
    ...
    self.runtime.routeZone = nil; self.runtime.pendingReplan = nil
...
function A:SelectBuild(id)
    ...
    self.runtime.selected = nil; self.runtime.running = false; self.runtime.routeZone = nil; self.runtime.pendingReplan = nil
...
function A:DeleteBuild(id)
    ...
    self.runtime.active = nil; self.runtime.running = false; self.runtime.routeZone = nil; self.runtime.pendingReplan = nil
    if self.ClearWaypoint then self:ClearWaypoint() end; self:Refresh()
end
